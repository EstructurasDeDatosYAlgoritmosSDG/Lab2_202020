...
def movies ():
    movies = []
    movies.append({'movies_id':'1', 'movie_title':'Title 1', 'author':'author 1'})
    movies.append({'movies_id':'2', 'movie_title':'Title 2', 'author':'author 2'})
    movies.append({'movies_id':'3', 'movie_title':'Title 3', 'author':'author 3'})
    movies.append({'movies_id':'4', 'movie_title':'Title 4', 'author':'author 4'})
    movies.append({'movies_id':'5', 'movie_title':'Title 5', 'author':'author 5'})
    print (movies[0])
    return movies
...
def test_isPresent (lstmovies, movies):
    movie = {'movies_id':'10', 'movie_title':'Title 10', 'author':'author 10'}
    assert slt.isPresent (lstmovies, movies[2]) > 0
    assert slt.isPresent (lstmovies, movies) == 0
...
def test_changeInfo (lstmovies):
    movie10 = {'movies_id':'10', 'movie_title':'Title 10', 'author':'author 10'}
